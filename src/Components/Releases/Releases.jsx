        ...
        <div className="release-container">
            ...
            <div className="release-info">
                ...
                <div className="release-info-pallet">
                    ...
                    />
                    <img 
                        onClick={()=>setLipsColor(RedLips)} 
                        onMouseOver={()=>setLipsColor(RedLips)} 
                        src={RedCircle} 
                        alt="circulo vermelho" 
                    />
                    <img 
                        onClick={()=>setLipsColor(BrownLips)} 
                        onMouseOver={()=>setLipsColor(BrownLips)} 
                        src={BrownCircle} 
                        alt="circulo marrom" 
                    />
                    <img 
                        onClick={()=>setLipsColor(BaseLips)} 
                        onMouseOver={()=>setLipsColor(BaseLips)} 
                        src={BaseCircle} 
